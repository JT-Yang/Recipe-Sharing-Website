<?php
   ...
   $SQL = "SELECT gid, gname from CookingGroup where creater = '$username'";
...
<ul class="nav navbar-nav navbar-right">
  ...
  <div class="jumbotron" style="margin: 0; height:146px;padding-top: 20px">
    <div class="container" align="center" style="background-image: url('backgroundHome.jpg')">
      ...
      <div class="text-muted" style="font-size:20px">Check out your intersting groups.</div>
    </div>
  </div>
  <br>

<h3><center>Groups created by <?php echo $username ?></center></h3>
 <div class="container">
 <div class="row">
  ...
  <div class="col-sm-6">
    <table class="table table-striped">
      ...
      while ($stmt->fetch()) {
          ...
          echo "<td><a href=group_display.php?gid=$gid target=_blank>$gid</a></td>";
          echo "<td>$gname</td>";
          echo "<td><a href=group_meeting.php?user=$_SESSION[user] target=_blank>Join</a></td>"; 
          //echo '</tr>';
        }
        ?>
      </tbody>
    ...
    <div class="col-sm-4">
      ...
      <a href="createGroup.php" target=_blank class="btn btn-danger" role="button">Create a Group</a>
