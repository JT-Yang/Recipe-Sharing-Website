<?php
   ...
   $SQL = "SELECT gid, gname, creater from CookingGroup";
...
<ul class="nav navbar-nav navbar-right">
  ...
  <div class="jumbotron" style="margin: 0; height:146px;padding-top: 20px">
    <div class="container" align="center" style="background-image: url('backgroundHome.jpg')">
      ...
      <div class="text-muted" style="font-size:20px">Check out your interesting group.</div>
    </div>
  </div>
  <br>
 ...
 <div class="row">
  ...
  <div class="col-sm-6">
    <table class="table table-striped">
      ...
      while ($stmt->fetch()) {
        ...
        //  echo "<td>$row[creater]</td>"; 
          ...
          echo "<td>$gname</td>";
        echo "<td>$creater</td>"; 
          echo "<td><a href=joinGroup.php?gid=$gid target=_blank>Join</a></td>"; ; 
          echo '</tr>';
        }
        ?>
      </tbody>
    ...
    <div class="col-sm-4">
      ...
      <a href="myGroups.php" target=_blank class="btn btn-info" role="button">My Groups</a>
